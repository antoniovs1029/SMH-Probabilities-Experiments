...
class MultipleFilesPrinter:
    ...
    def __init__(self, topicprobsfile, vocab_words, outputpath):
        ...
        :param topicprobsfile: file containing the probabilities, it is the output of the probabilitiescreator module
        :param vocab_words: list of words where the 'i'-th element is the word with id #i
    ...
    def print_topics(self, maxtopics = None):
        ...
        :param maxtopics: number of topics that should be printed, if empty, this method will print all topics
        :return: returns nothing
        """
    ...
    def _prepare_output_path(self):
        # TODO: Create this method to erase the contents of the path, if they exist already, and to create the directory if it doesn't exist
        pass        

class SingleFileSummaryPrinter:
    """
    Prints one file that summarizes all the topics by outputing the top words of the topic
    one word per line, along with some statistics.
    """
